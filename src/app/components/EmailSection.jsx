...
const EmailSection = () => {
  ...
  return (
    ...
    >
      <div className="bg-gradient-radial from-blue-900 to-transparent rounded-full h-80 w-80 blur-lg absolute top-1/4 -left-4 transform -translate-x-1/2 z-1 top hidden sm:block lg:block"></div>
